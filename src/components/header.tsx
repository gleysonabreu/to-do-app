              ...
              <Sheet>
                ...
                <SheetContent side='left'>
                  <SheetHeader>
                    <SheetTitle>
                      <Link href='/'>
                        <Image src='/logo.svg' alt='Logo' width={121} height={43} className="w-24" />
                      </Link>
                    </SheetTitle>
                  </SheetHeader>
                  ...
                  <div className='pb-10 my-6'>
                    <div className="flex flex-col pl-6 space-y-3 mb-6">
                      <Link href='/dashboard' className="px-3 py-2 hover:text-zinc-400 transition-all">Dashboard</Link>
                    </div>
                    ...
                    <div className="border-t pt-4 border-zinc-800">
                      ...
                      <div className="flex flex-col pl-6 space-y-3 mt-6">
                        <Button type='button' onClick={() => signOut()} size='sm'>
                          Sign out
                        </Button>
                      </div>
                    </div>
